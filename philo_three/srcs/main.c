...
/*   Updated: 2021/03/09 08:32:36 by knfonda          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (philo->parse->count_eat && philo->count_eat\
	== philo->parse->count_eat && philo->table->stop_eating != 1)
	{
		philo->table->stop_eating = 1;
...
static int	test(t_philo *philo)
{
	...
	{
		if (philo->parse->count_eat && philo->table->stop_eating != 1)
